...
export default function DocumentationSection() {
  ...
  const cards = [
    {
      title: 'Phase 0-1 foundation',
      description:
        'Monorepo, auth, orgs, campaign setup,\npublisher onboarding, and first serving path.',
      image: '/modern-dashboard-interface-with-data-visualization.jpg',
    },
    {
      title: 'Execution latency discipline',
      description:
        'No chain calls in bidding, no cold DB reads,\nprecomputed targeting and hot-state auctions.',
      image: '/analytics-dashboard.png',
    },
    {
      title: 'Trust and attribution moat',
      description:
        'Wallet graph segments, fraud scoring,\npost-bid settlement proofs and audit trails.',
