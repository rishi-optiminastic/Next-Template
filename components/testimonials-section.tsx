  ...
  const testimonials = [
    {
      ...
      name: 'Arjun Patel',
      company: 'Head of Ad Ops, Vertex DSP',
      image:
    ...
    {
      quote:
        'The phased build order helped us launch real ad serving first, then layer in wallet segments and fraud scoring without rework.',
      name: 'Maya Thompson',
      company: 'VP Platform, Atlas Media',
      image:
    ...
    {
      quote:
        'Batch USDC settlements plus append-only ledgers gave finance and publisher teams transparent payouts with clear audit trails.',
      name: 'Elena Brooks',
      company: 'Finance Lead, Nova Exchange',
      image:
